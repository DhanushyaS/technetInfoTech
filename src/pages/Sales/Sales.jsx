...
function Sales() {
  const product=[{name:'RAM',description:" Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita harum animi maiores di",image:"https://images.unsplash.com/photo-1611663806011-b37e091090f0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=773&q=80"},
  {name:'MSI',description:" Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita harum animi maiores di",image:"https://images.unsplash.com/photo-1609581771681-9a920ff90f26?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8bXNpfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=600&q=60"},
    ...
    {product.map((ele,index)=>{
      return(
        ...
        <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
          ...
          <Link to={`/accessories/${ele}`} class="rounded-full bg-neutral-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60">Order Now</Link>
        </div>
      </div>
      )
    })}
